...
public class PlaygroundRoleplayRoleServiceImpl implements com.ai.agent.real.application.service.PlaygroundRoleplayRoleService {
    ...
    public Mono<PlaygroundRoleplayRole> createRole(RoleCreateRequest request) {
        ...
        return Mono.defer(() -> {
                ...
                .doOnSuccess(savedRole -> log.info("创建角色成功: id={}, voice={}, name={}, avatarUrl={}",
                        savedRole.getId(), savedRole.getVoice(), savedRole.getName(), savedRole.getAvatarUrl()))
    ...
    public Mono<PlaygroundRoleplayRole> updateRole(Long id, RoleCreateRequest request) {
        ...
        return roleRepository.findById(id)
                ...
                .doOnSuccess(updatedRole -> log.debug("更新角色成功: id={}, voice={}, name={}",
                        updatedRole.getId(), updatedRole.getVoice(), updatedRole.getName()))
    ...
    public Mono<PlaygroundRoleplayRole> toggleRoleStatus(Long id) {
        return roleRepository.findById(id)
                ...
                .flatMap(roleRepository::save)
                .doOnSuccess(updatedRole -> log.info("切换角色状态成功: id={}, status={}",
                        updatedRole.getId(), updatedRole.getStatus()))
