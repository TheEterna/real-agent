...
/**
 * 文档生成专家Agent 专门处理技术文档、API文档、用户手册等文档生成任务
 *
 * @author han
 * @time 2025/9/7 00:20
 */
...
public class DocumentationAgent extends Agent {
	...
	public DocumentationAgent(ChatModel chatModel, ToolService toolService) {
		super("documentation-agent", "文档生成专家", "专门处理各类技术文档生成任务", chatModel, toolService,
				Set.of("文档", "说明", "手册", "指南", "readme", "api文档", "注释", "规范", "文档生成", "documentation", "manual",
						"guide", "comment", "specification", "doc", "md", "markdown"));
