...
/**
 * 代码分析专家Agent 专门处理代码分析、代码审查、架构分析等任务
 *
 * @author han
 * @time 2025/9/7 00:15
 */
...
public class CodeAnalysisAgent extends Agent {
	...
	public CodeAnalysisAgent(ChatModel chatModel, ToolService toolService) {
		super("code-analysis-agent", "代码分析专家", "专门处理代码分析和架构分析任务", chatModel, toolService,
				Set.of("代码", "架构", "分析", "审查", "优化", "重构", "设计模式", "性能", "安全", "漏洞", "规范", "最佳实践", "code",
						"architecture", "analysis", "review", "optimize", "refactor", "design pattern", "performance",
