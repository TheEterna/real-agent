...
//// .sorted((a1, a2) -> Double.compare(a2.getConfidenceScore(task),
// a1.getConfidenceScore(task)))
// .toList();
//
...
// AgentResult errorResult = AgentResult.failure("执行异常: " + e.getMessage(),
// agent.getAgentId());
...
// * 整合流水线结果
// */
// private AgentResult integratePipelineResults(List<AgentResult> stageResults, String
// originalTask, List<Agent> agents) {
...
//
// resultBuilder.append("阶段 ").append(i + 1).append("
// [").append(agent.getAgentName()).append("]: ");
// if (stageResult.isSuccess()) {
