...
// if (urlStr.isEmpty()) {
// return ToolResult.error(ToolResultCode.TOOL_EXECUTION_ERROR, "url is required",
// getId());
// }
// URL url = new URL(urlStr);
// if (!policy.isHostAllowed(url.getHost())) {
// return ToolResult.error(ToolResultCode.TOOL_EXECUTION_ERROR, "host not allowed" ,
// getId());
// }
// String method = String.valueOf(args.getOrDefault("method", "GET")).toUpperCase();
// if (!policy.isMethodAllowed(method)) {
// return ToolResult.error(ToolResultCode.TOOL_EXECUTION_ERROR, "method not allowed",
// getId());
// }
//
...
// }
// br.close();
// return ToolResult.ok(Map.of("status", code, "body", sb.toString()),
