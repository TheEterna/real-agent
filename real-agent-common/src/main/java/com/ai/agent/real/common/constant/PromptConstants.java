...
public class PromptConstants {
	...
	public static final String PLAN_MODE_PLAN_ADVANCE_TOOL_PROMPT = """
			- 当 局部任务/子任务/当前任务 结束时，你应该调用 plan_advance 工具来推动任务继续进行 \n
			""";

	// In plan mode，plaUpdate Tool prompt
	public static final String PLAN_MODE_PLAN_UPDATE_TOOL_PROMPT = """
	...
	public static final String PLAN_MODE_TASK_DONE_TOOL_PROMPT = """
