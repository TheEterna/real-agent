...
/**
 * ASR via DashScope paraformer-v2 (short audio REST). If no API key configured, return a
 * placeholder text so the pipeline works.
 *
 * @author han
...
public class AsrService {
	...
	public Mono<String> transcribe(byte[] audioBytes, String mimeType) {
		...
		// Prefer to pass base64 data; if mimeType is webm/opus and not supported, we will
		// later add a transcode step.
		String base64 = Base64.getEncoder().encodeToString(audioBytes);

		// NOTE: Endpoint path may vary across DashScope versions. We'll use a commonly
		// documented path and leave TODO to adjust.
	...
	// Very lightweight extraction; TODO: replace with JSON parsing of DashScope response
	// schema
