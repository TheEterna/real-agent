...
public class OmniServerEvent {
    ...
    private String transcript; // for conversation.item.input_audio_transcription.completed
    private String sessionId; // for session.created -> session.id

    public OmniServerEvent() {}

    public OmniServerEventType getType() { return type; }
    public void setType(OmniServerEventType type) { this.type = type; }

    public String getDelta() { return delta; }
    public void setDelta(String delta) { this.delta = delta; }

    public AudioPayload getAudio() { return audio; }
    public void setAudio(AudioPayload audio) { this.audio = audio; }
