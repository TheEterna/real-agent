...
// return "trace-" + System.currentTimeMillis() + "-" + Integer.toHexString((int)
// (Math.random() * 0x10000));
// }
//
// @Autowired
...
// Flux.defer(() -> {
// AgentContext thinkingCtx = AgentUtils.createAgentContext(context,
...
// return FluxUtils.stage(actionAgent.executeStream(task, actionCtx), context,
...
// AgentContext observingCtx = AgentUtils.createAgentContext(context,
